...
sealed class WireActivity with _$WireActivity implements HasWireActivity {
  ...
  @override
  Object? get context =>
      map(wireCreate: (v) => v.context, wireDelivered: (v) => v.context);

  @override
  Uri? get id => map(wireCreate: (v) => v.id, wireDelivered: (v) => v.id);

  @override
  List<Uri> get to => map(wireCreate: (v) => v.to, wireDelivered: (v) => v.to);

  @override
  Uri get actor =>
      map(wireCreate: (v) => v.actor, wireDelivered: (v) => v.actor);

  String get type =>
      map(wireCreate: (_) => 'Create', wireDelivered: (_) => 'Delivered');
}
